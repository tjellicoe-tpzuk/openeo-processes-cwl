...
from openeo_processes_dask_new.process_implementations.data_model import RasterCube
from openeo_processes_dask_new.process_implementations.exceptions import (
    BandExists,
    DimensionAmbiguous,
    NirBandAmbiguous,
    RedBandAmbiguous,
)
from openeo_processes_dask_new.process_implementations.math import normalized_difference
